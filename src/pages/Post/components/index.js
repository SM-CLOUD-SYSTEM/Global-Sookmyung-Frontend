...
export { default as CommentInput } from '@pages/Post/components/CommentInput';
export { default as LikeButton } from '@pages/Post/components/LikeButton';
export { default as PostHeader } from '@pages/Post/components/PostHeader';
